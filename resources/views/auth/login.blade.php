...
<body>
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="#" class="d-inline-block auth-logo">
                                    {{-- <img src="{{ asset('velzon/assets/images/auth-one-bg.jpg') }}" alt="" height="120"> --}}
                                </a>
                            </div>
                                ...
                                <div class="p-2 mt-4">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control  @error('email') is-invalid @enderror" id="email" name="email" placeholder="{{ __('Email Address') }}" required autocomplete="email" autofocus>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Crafted with <i class="mdi mdi-heart text-danger"></i> by <a href="https://github.com/maman-heryanto">ReXM</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!-- particles js -->
    <script src="{{ asset('velzon/assets/libs/particles.js/particles.js') }}"></script>
    <script src="{{ asset('velzon/assets/js/pages/particles.app.js') }}"></script>

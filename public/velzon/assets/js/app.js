!(function () {
    ...
    function b() {
        ...
        !(o = JSON.parse(o)) ||
            ...
            ((e = document.createElement("ul")).innerHTML =
            ...
            (o = (o =
                ...
                (!(o = document
                    .getElementById("navbar-nav")
                    .querySelector('[href="' + o + '"]')) ||
                    ((t = o.closest(".collapse.menu-dropdown")) &&
                        (t.classList.add("show"),
                        t.parentElement.children[0].classList.add("active"),
                        t.parentElement.children[0].setAttribute(
                            "aria-expanded",
                            "true"
                        ),
                        t.parentElement.closest(".collapse.menu-dropdown") &&
                            (t.parentElement
                                .closest(".collapse")
                                .classList.add("show"),
                            t.parentElement.closest(".collapse")
    ...
    function f() {
        "vertical" == document.documentElement.getAttribute("data-layout") &&
            ...
            "horizontal" ==
                document.documentElement.getAttribute("data-layout") && I();
    }
    function p() {
        feather.replace();
        ...
        e < 1025 && 767 < e
            ...
            document
                ...
                .forEach(function (e) {
                    e.addEventListener("click", E.bind(this), !1),
                        e.addEventListener("mouseover", E.bind(this), !1);
                });
    }
    function E(e) {
    ...
    function I() {
        ...
        e.forEach(function (a, o) {
            o + 1 === 7 && (t = a),
                7 < o + 1 && (a.outerHTML, a.remove()),
                o + 1 === e.length && t.insertAdjacentHTML;
        });
    }
    function L(e) {
        "vertical" == e
                ...
                t == a.value ? (a.checked = !0) : (a.checked = !1),
                    a.addEventListener("change", function () {
                        document.documentElement.setAttribute(e, a.value),
                            ...
                            "data-layout" == e &&
                                ("vertical" == a.value
                                    ? (L("vertical"), y(), feather.replace())
                                    : "horizontal" == a.value
                                    ? (L("horizontal"), feather.replace())
                                    : "twocolumn" == a.value &&
                                      (L("twocolumn"),
                                      document.documentElement.setAttribute(
                                          "data-layout-width",
    ...
    sessionStorage.getItem("defaultAttribute")
        ...
        : ((i = document.documentElement.attributes),
          ...
          i.forEach(function (t) {
              ...
              t &&
                  t.nodeName &&
                  "undefined" != t.nodeName &&
                  ((a = t.nodeName),
                  (e[a] = t.nodeValue),
                  sessionStorage.setItem(a, t.nodeValue));
          }),
          sessionStorage.setItem("defaultAttribute", JSON.stringify(e)),
          k(e),
        ...
        (a = document.getElementById("search-dropdown")),
        (o = document.getElementById("search-options")) &&
            (o.addEventListener("focus", function () {
                0 < o.value.length
                    ? (a.classList.add("show"), t.classList.remove("d-none"))
        ...
        (s = document.getElementById("search-dropdown-reponsive")),
        ...
        document.addEventListener("webkitfullscreenchange", x),
        document.addEventListener("mozfullscreenchange", x),
        ...
        (i = document.querySelectorAll(".light-dark-mode")) &&
            ...
            i[0].addEventListener("click", function (e) {
                ...
                "dark" == l.getAttribute("data-layout-mode")
                    ? q("data-layout-mode", "light", "layout-mode-light", l)
                    : q("data-layout-mode", "dark", "layout-mode-dark", l);
            }),
        (function () {
                ...
                document
                    ...
                    .forEach(function (e) {
                        e.addEventListener("change", function () {
                            var t = (a = e.closest(".card")).querySelector(
                                    ".live-preview"
                                ),
